...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="fw-bold text-white">Registrar Nueva Compra</h2>
        ...
        <form action="{{ route('admin.compras.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="usuario_id" id="usuario_id" class="form-control" value="{{ auth()->user()->id }}" readonly>
                    @error('usuario_id')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <!-- Tabla para agregar ingredientes (Detalle Compra) -->
...
<script>
    ...
    agregarIngredienteBtn.addEventListener('click', function() {
        ...
        nuevoSelect.addEventListener('change', function() {
            ...
            actualizarSubtotal(tablaIngredientes.children.length - 1);  // Actualizamos el subtotal
        });
